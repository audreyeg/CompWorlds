...
ASSET_MANAGER.queueDownload("./sprites/dynimite.png");
ASSET_MANAGER.queueDownload("./sprites/Explosion.png");
ASSET_MANAGER.queueDownload("./sprites/Sign (3).png");
...
ASSET_MANAGER.queueDownload("./sprites/CaveTileset.png");
...
ASSET_MANAGER.queueDownload("./sprites/guide.png");
ASSET_MANAGER.queueDownload("./sprites/sheriffnpc.png");
ASSET_MANAGER.queueDownload("./sprites/bartender.png");
ASSET_MANAGER.queueDownload("./sprites/banker.png");
ASSET_MANAGER.queueDownload("./sprites/random.png");
